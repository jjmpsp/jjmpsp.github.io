        ...
        <ul class="inner">
            <li>
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th scope="row">
                            <img class="technology-img" src="static/img/technologies/windows.jpg" title="Windows"
                                 alt="Windows">
                        </th>
                    ...
                    <tr>
                        <th scope="row">
                            <img class="technology-img" src="static/img/technologies/windowsserver.jpg"
                    ...
                    <tr>
                        <th scope="row">
                            <img class="technology-img" src="static/img/technologies/macos.png" title="Mac OS"
                                 alt="Mac OS">
                        </th>
                        <td>
                            Mac OS
                    ...
                    <tr>
                        <th scope="row">
                            <img class="technology-img" src="static/img/technologies/centos.jpg" title="Cent OS"
                                 alt="Cent OS">
                        </th>
                        <td>CentOS</td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <img class="technology-img" src="static/img/technologies/ubuntu.jpg" title="Ubuntu"
                                 alt="Ubuntu">
                        </th>
                        <td>Ubuntu</td>
                    </tr>
        ...
        <ul class="inner">
            <li>
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/php.png" title="PHP" alt="PHP">
                        </td>
                    ...
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/laravel.png" title="Laravel"
                                 alt="Laravel"></td>
                        <td>Laravel Framework [<a target="_blank" href="https://laravel.com">laravel.com</a>]</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/zend.png" title="Zend" alt="Zend">
                        </td>
                        <td>Zend Framework [<a target="_blank" href="https://framework.zend.com">framework.zend.com</a>]
                        </td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/wordpress.png" title="WordPress"
                                 alt="WordPress"></td>
                        <td>WordPress [<a target="_blank" href="https://wordpress.com/">wordpress.com</a>]</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/composer.png" title="Composer"
                                 alt="Composer"></td>
                        <td>Composer [<a target="_blank" href="https://getcomposer.org">getcomposer.org</a>]</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/phpunit.jpeg" title="PHPUnit"
                                 alt="PHPUnit"></td>
                        <td>PHPUnit [<a target="_blank" href="https://phpunit.de/">phpunit.de</a>]</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/php.png" title="Windows"
                                 alt="Windows"></td>
                        <td>XDebug [<a target="_blank" href="https://xdebug.org/">xdebug.org</a>]</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/windows.jpg" title="Windows" alt="Windows"></td>
        ...
        <ul class="inner">
            <li>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/mysql.png" title="MySQL Server"
                                 alt="MySQL Server"></td>
                        <td> MySQL - https://www.mysql.com/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/windows.jpg"
                                 title="Microsoft SQL Server" alt="Microsoft SQL Server"></td>
                        <td>MS SQL - https://www.microsoft.com/en-us/sql-server/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/mongodb.png" title="MongoDB"
                                 alt="MongoDB"></td>
                        <td> MongoDB - https://www.mongodb.com/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/postgresql.png" title="PostgreSQL"
                                 alt="PostgreSQL"></td>
        ...
        <ul class="inner">
            <li>
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/html5.png" title="HTML5"
                                 alt="HTML5"></td>
                        <td>HTML5 - https://www.w3.org/TR/2014/REC-html5-20141028/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/css3.png" title="CSS3" alt="CSS3">
                        </td>
                    ...
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/bootstrap.png" title="BootStrap"
                                 alt="BootStrap"></td>
                        <td>Bootstrap [<a target="_blank" href="https://getbootstrap.com/">getbootstrap.com</a>]</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/less.png" title="LESS" alt="LESS">
                        </td>
                        <td>LESS [<a target="_blank" href="https://lesscss.org/">lesscss.org</a>]</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/sass.png" title="LESS" alt="LESS">
                        </td>
                        <td>Sass &amp; SCSS modules [<a target="_blank" href="https://sass-lang.com/">sass-lang.com</a>]
                        </td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/javascript.jpeg" title="JavaScript" alt="JavaScript"></td>
                        <td>Javascript [more]</td>
                    </tr>

                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/es6.jpg" title="ES6" alt="ES6"></td>
                        <td>ES6</td>
                    </tr>

                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/typescript.jpg" title="TypeScript"
                                 alt="TypeScript"></td>
                    ...
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/react.png" title="ReactJS"
                                 alt="ReactJS"></td>
                        <td>React [<a target="_blank" href="https://reactjs.org/">reactjs.org</a>]</td>
                    </tr>

                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/redux.png" title="Redux"
                                 alt="Redux"></td>
                    ...
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/angularjs.png" title="AngularJS"
                                 alt="AngularJS"></td>
                    ...
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/coffeescript.png"
                                 title="CoffeeScript" alt="CoffeeScript"></td>
                        <td>CoffeeScript [<a target="_blank" href="https://coffeescript.org/">coffeescript.org</a>]</td>
                    </tr>

                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/jquery.png" title="jQuery"
                                 alt="jQuery"></td>
                        <td>JQuery [<a target="_blank" href="https://jquery.com/">jquery.com</a>]</td>
                    </tr>

                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/requirejs.png" title="RequireJS"
                                 alt="RequireJS"></td>
                        <td>RequireJS [<a target="_blank" href="https://requirejs.org/">requirejs.org</a>]</td>
                    </tr>

                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/jasmine.png" title="Jasmine"
                                 alt="Jasmine"></td>
        ...
        <ul class="inner">
            <li>
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/docker.png" title="Docker"
                                 alt="Docker"></td>
                        <td>Docker - https://www.docker.com/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/vagrant.png" title="Vagrant"
                                 alt="Vagrant">
                        </td>
                        <td>Vagrant - https://www.vagrantup.com/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/ansible.png" title="Ansible"
                                 alt="Ansible">
                        </td>
                        <td>Ansible - https://www.ansible.com/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/terraform.png" title="Terraform"
                                 alt="Terraform"></td>
                        <td>Terraform - https://www.terraform.io/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/windows.jpg" title="Packer"
                                 alt="Packer"></td>
                        <td>Packer - https://www.packer.io/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/kubernetes.png" title="Kubernetes"
                                 alt="Kubernetes"></td>
                        <td>Kubernetes - https://kubernetes.io/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/travis.jpeg" title="Travis"
                                 alt="Travis"></td>
                        <td>Travis - https://travis-ci.org</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/heroku.png" title="Heroku"
                                 alt="Heroku"></td>
                        <td>Heroku - https://www.heroku.com/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/chef.png" title="Chef" alt="Chef">
                        </td>
                        <td>Chef - https://www.chef.io/</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/puppet.png" title="Puppet"
                                 alt="Puppet"></td>
        ...
        <ul class="inner">
            <li>
                <table class="table table-bordered">
                    ...
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/virtualbox.png"
                                 title="VirtualBox"
                                 alt="VirtualBox"></td>
                        <td>Virtualbox Hypervisor</td>
                    </tr>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/technologies/vmware.png" title="VMWare"
                                 alt="VMWare"></td>
                        <td>VMWare</td>
                    </tr>
                    </tbody>
        ...
        <ul class="inner">
            <li>
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr scope="row">
                        <td><img class="technology-img" src="static/img/crane.png" title="DevOps & Infrastructure" alt="DevOps & Infrastructure"></td>
